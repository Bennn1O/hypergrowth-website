...
export const metadata: Metadata = {
  ...
  description:
    "Mesurez votre maturité de passage à l'échelle et identifiez vos priorités d'action en 10 minutes.",
};
...
const stats = [
  ...
  { value: "10 min", label: "pour compléter le test" },
    ...
    <main className="flex flex-col items-stretch">
      <section className="relative overflow-hidden pt-[180px] pb-10 max-[767px]:pt-[130px]">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 80% 0%, #7d3fab 0%, transparent 65%)",
          }}
        />
        <div className={containerClass}>
          <div className="flex flex-col gap-5 max-w-[640px]">
            ...
            <p className="max-w-[480px] text-[0.95rem] font-normal leading-[1.7] text-hpg-silver">
              10 minutes. 6 dimensions. Un diagnostic honnête de votre
              organisation, et les vrais blocages que la croissance masque.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-3 gap-4 max-[991px]:grid-cols-2 max-[479px]:grid-cols-1">
              {dimensions.map((dim) => (
                <div
                  key={dim.num}
                  className={`flex flex-col gap-4 rounded-[12px] p-6 ${glassClass}`}
                >
          ...
          >
            <div className="flex flex-col items-center gap-5">
              ...
              <p className="max-w-[480px] font-normal leading-[1.7] text-hpg-silver">
                Un Operating Partner analyse votre résultat avec vous en 30
                minutes. Pas d&apos;engagement, juste de la clarté.
              </p>
              <Link
                href="/contact"
