        ...
        <div className={containerClass}>
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-[clamp(4rem,9vw,7.5rem)] font-bold leading-[1]">
              L&apos;amour de la{' '}
              <span className="font-instrument-italic italic text-hpg-orchid">performance</span>
            </h1>
            <p className="max-w-[560px] text-base font-medium leading-[1.6] text-hpg-silver">
        ...
        <div className={containerClass}>
          <div className="grid grid-cols-4 gap-4 max-[767px]:grid-cols-2 max-[479px]:grid-cols-1">
            {stats.map((stat) => (
              ...
              >
                <span className="font-instrument-italic italic text-[3rem] leading-none text-hpg-orchid">
                  {stat.value}
                </span>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="text-[clamp(2.4rem,5.5vw,4rem)] font-medium leading-[1.08]">
                ...
                <span className="font-instrument-italic italic text-hpg-orchid">Experts</span>{' '}
                de l&apos;écosystème
              </h2>
            </div>
