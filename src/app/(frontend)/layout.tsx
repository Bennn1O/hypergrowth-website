...
export const metadata: Metadata = {
  title:
    "Scaling stratégique et conseil pour dirigeants ambitieux | HyperGrowth",
  description:
    "Accélérez la croissance de votre entreprise avec un Operating Partner dédié. Structuration, méthodologie OP-X, réseau d'élite – entrez dans l'écurie HyperGrowth.",
  keywords: [
    "scaling",
    "hypercroissance",
    "operating partner",
  ...
  openGraph: {
    title:
      "Scaling stratégique et conseil pour dirigeants ambitieux | HyperGrowth",
    description:
      "Accélérez la croissance de votre entreprise avec un Operating Partner dédié.",
    images: [
      "/images/68df88f9c3bc25774b700adf_1cbfc1f48d56e188805ab8fc77bb484c_HPG_website_open-graph.png",
    ],
    type: "website",
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html
      lang="fr-FR"
      className={`${archivo.variable} ${archivoItalic.variable} ${instrument.variable} ${instrumentItalic.variable}`}
    >
      <head>
        <link
          rel="icon"
          href="/images/68df88f2746392ab1ec9141b_HPG_website_fav-icon.png"
        />
        <link
          rel="apple-touch-icon"
          href="/images/68df88f650217f54f596a7c6_HPG_website_webclip.png"
        />
        <link
          rel="preload"
          as="image"
