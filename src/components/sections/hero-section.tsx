...
const logos = [
  ...
  {
    src: "/images/690b518dd86eff19215d6875_HPG_web_logos-partenaires_12.avif",
    width: 100,
  },
  {
    src: "/images/690b518d4cca311dae76b1e0_HPG_web_logos-partenaires_14.avif",
    width: 120,
  },
  {
    src: "/images/690b518c1b1be138f398eb4e_HPG_web_logos-partenaires_13.avif",
    width: 100,
  },
  {
    src: "/images/690b518ce5274c3996037d83_HPG_web_logos-partenaires_11.avif",
    width: 150,
  },
];
...
const containerClass =
  "mx-auto block max-w-[var(--width-container)] overflow-hidden px-20 py-10 max-[991px]:w-[95vw] max-[991px]:max-w-[95vw] max-[991px]:px-10 max-[767px]:px-4 max-[479px]:w-[95vw] max-[479px]:max-w-[95vw] max-[479px]:px-4";
  ...
  return (
    <section className="relative mb-6 overflow-hidden pt-[clamp(5.4rem,10vw,7.5rem)] max-[767px]:mb-4 max-[767px]:pt-26 md:mb-10">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #f285f0, transparent 70%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #803fab, transparent 70%)",
        }}
      />
        ...
        <div className="flex flex-col items-center justify-between gap-[clamp(3rem,6vw,5rem)] py-[clamp(1.1rem,3vw,2.5rem)] max-[767px]:gap-16 max-[479px]:px-4">
          ...
          <div className="flex w-full flex-col items-center gap-8 text-center max-[767px]:gap-6">
            ...
            <p className="hpg-hero-animate hpg-hero-animate-3 mx-auto max-w-[52ch] text-[clamp(0.95rem,1.4vw,1.1rem)] leading-[1.65] text-hpg-silver/80 max-[767px]:max-w-[40ch]">
              Ce n&apos;est pas du conseil. C&apos;est un système de pilotage
              vivant, jusqu&apos;à ce que votre organisation tienne sans nous.
            </p>
          ...
          <div className="hpg-hero-animate hpg-hero-animate-4 flex w-full flex-col items-center justify-center gap-2 overflow-hidden md:gap-3">
            <span className="text-[0.75rem] font-medium uppercase tracking-[0.1em] text-white/40 max-[479px]:text-[0.65rem]">
