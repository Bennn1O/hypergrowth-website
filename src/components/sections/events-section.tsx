            ...
            {eventList.map((event, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={event.href}
                    className={`relative flex items-center justify-between gap-6 overflow-hidden rounded-xl border border-white/10 bg-white/[0.02] px-6 py-5 transition max-[991px]:flex-col max-[991px]:items-start ${past ? 'opacity-50 grayscale-[30%]' : 'hover:-translate-y-0.5 hover:border-hpg-orchid/25 hover:bg-[rgb(24_10_34_/_0.3)]'}`}
                  >
