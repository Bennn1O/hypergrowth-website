          ...
          <div className="flex gap-6 max-[991px]:flex-col">
            ...
            >
              <Link
                ...
                className={`flex h-full flex-col justify-between gap-8 rounded-xl p-8 transition hover:-translate-y-0.5 hover:border-hpg-orchid/25 ${glassClass}`}
              >
            ...
            <div ref={listRef} className="flex w-1/2 flex-col gap-4 max-[991px]:w-full">
              {articles.map((article, index) => (
                ...
                >
                  <Link
                    href={article.href}
                    className="flex flex-1 items-center gap-5 rounded-xl border border-transparent p-3 transition hover:-translate-y-0.5 hover:border-hpg-orchid/25 hover:bg-white/[0.02]"
                  >
