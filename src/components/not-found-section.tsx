      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="grid gap-12 md:grid-cols-2 md:gap-8">
          ...
          <div className="flex flex-col justify-center gap-8">
            <div>
              <div className="text-8xl font-bold leading-none text-hpg-orchid font-instrument md:text-9xl">
                404
              </div>
              <h1 className="mt-4 text-3xl font-400 leading-tight text-white md:text-4xl">
                {title}
              </h1>
              <p className="mt-3 text-base font-300 leading-relaxed text-hpg-silver md:text-lg">
                {description}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-[10px] bg-hpg-violet px-6 py-3 font-400 text-white transition-all duration-200 hover:bg-hpg-night hover:text-hpg-orchid"
              >
                {primaryAction.label}
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 border-b border-[#cfcfcf] px-0 py-3 font-400 text-hpg-silver transition-all duration-200 hover:border-white hover:text-white"
              >
          ...
          <div className="relative flex items-center justify-center">
              ...
              <div className="h-96 w-full rounded-[10px] bg-gradient-to-br from-[#803fab]/20 to-[#f285f0]/10 p-8 text-center md:h-full">
                <div className="flex h-full items-center justify-center">
                  <div className="space-y-4">
                    <div className="text-6xl font-bold text-hpg-orchid/20 font-instrument">?</div>
                    <p className="text-sm font-300 text-hpg-silver">Contenu visuel personnalisé</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="absolute inset-0 -z-10 overflow-hidden rounded-[10px]">
              ...
              <div className="absolute -right-32 -top-32 h-64 w-64 rounded-full bg-hpg-violet/10 blur-3xl" />
              <div className="absolute -bottom-32 -left-32 h-64 w-64 rounded-full bg-hpg-orchid/10 blur-3xl" />
            </div>
          </div>
        </div>
          ...
          <div className="mt-16 border-t border-[#414141] pt-12 md:mt-20">
            ...
            <nav className="mt-6 grid gap-4 sm:grid-cols-2 md:grid-cols-4">
              {helpLinks.map((link) => (
                ...
                >
                  <p className="font-400 text-hpg-orchid group-hover:text-white">{link.label}</p>
                  <p className="mt-1 text-sm font-300 text-hpg-silver">{link.description}</p>
                </Link>
              ))}
            </nav>
          </div>
