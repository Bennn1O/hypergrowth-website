  ...
  return (
    <main className="flex flex-col items-stretch">
      ...
      <section className="mx-auto w-full pb-16">
        <div className={containerClass}>
          <div className="flex flex-col gap-10 text-[0.95rem] font-thin leading-[1.8] text-[#cfcfcf]">
            {/* Éditeur */}
              ...
              <ul className="flex flex-col gap-1 pl-5">
                ...
                <li>
                  ...
                  <a
                    ...
                    className="text-[#f285f0] transition hover:opacity-70"
                  >
            ...
            <div className="pt-4">
              <Link
                href="/"
                className="text-[0.9rem] font-medium text-[#f285f0] transition hover:opacity-70"
              >
                ← Retour à l&apos;accueil
              </Link>
            </div>
