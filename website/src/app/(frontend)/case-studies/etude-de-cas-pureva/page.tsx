      ...
      <section className="relative overflow-hidden pt-[180px] pb-12 max-[767px]:pt-[130px]">
        ...
        <div className={containerClass}>
          <div className="flex flex-col items-center text-center gap-5">
            ...
            <p className="max-w-[540px] text-[1rem] font-thin leading-[1.7] text-[#cfcfcf]">
      ...
      <section className="mx-auto w-full">
        <div className={containerClass}>
          <div className="flex items-start gap-8 max-[767px]:flex-col">
            ...
            <div className="flex flex-1 gap-4 max-[767px]:flex-col">
              {/* Désirs */}
              <div className="flex flex-1 flex-col gap-6 rounded-[12px] bg-[#7d3fab] p-8 shadow-[0_16px_40px_rgb(80_20_120_/_0.35)]">
      ...
      <section className="mx-auto w-full">
        <div className={containerClass}>
          <div className="flex gap-8 max-[767px]:flex-col">
            {/* Témoignage */}
            <div className="relative flex flex-1 flex-col gap-6 overflow-hidden rounded-[12px] bg-[#7d3fab] p-10 max-[767px]:p-8">
              <div
            ...
            <div className="flex w-[280px] shrink-0 flex-col gap-4 max-[767px]:w-full max-[767px]:flex-row max-[479px]:flex-col">
              <div className={`flex flex-1 flex-col gap-2 rounded-[12px] p-8 ${glassClass}`}>
                <span className="font-instrument-italic italic text-[2.8rem] leading-none text-[#f285f0]">
                  +230%
                </span>
                <span className="mt-2 text-[0.85rem] font-thin leading-[1.5] text-[#cfcfcf]">
