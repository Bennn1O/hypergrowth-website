        ...
        <div className={containerClass}>
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <h1 className="text-[clamp(3.5rem,8vw,6.5rem)] font-medium leading-[1.02]">
              La Méthode{' '}
              <span className="font-instrument-italic italic text-[#f285f0]">OP-X</span>
            </h1>
          ...
          <div className="flex flex-col gap-12">
            <div className="mx-auto flex max-w-[680px] flex-col items-center text-center gap-4">
              ...
              <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-medium leading-[1.1]">
                ...
                <span className="font-instrument-italic italic text-[#f285f0]">noeuds.</span>
              </h2>
            ...
            <div className="grid grid-cols-3 gap-4 max-[767px]:grid-cols-1">
              {[
                ...
                >
                  ...
                  <p className="text-[0.9rem] font-thin leading-[1.6] text-[#cfcfcf]">{p.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className={containerClass}>
          <div className={`flex flex-col gap-8 rounded-[12px] p-10 ${glassClass} max-[767px]:p-6`}>
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <p className="max-w-[460px] text-[0.9rem] font-thin leading-[1.7] text-[#cfcfcf]">
        ...
        <div className={containerClass}>
          ...
          >
            ...
            <h2 className="max-w-[700px] text-[clamp(2rem,4vw,3.2rem)] font-medium leading-[1.08]">
              ...
              <span className="font-instrument-italic italic text-[#f285f0]">décisions</span>
            </h2>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-16 py-16 max-[991px]:flex-col max-[991px]:gap-8 max-[767px]:py-10">
              <div className="flex flex-1 flex-col gap-8">
                <span className="font-instrument-italic italic text-[5.5rem] leading-none text-[#f285f0] max-[767px]:text-[4rem]">
                  OP
                </span>
                ...
                <ul className="flex flex-col gap-3">
                  {opItems.map((item) => (
                    <li key={item} className="flex items-center gap-3 text-[0.9rem] text-[#cfcfcf]">
                      <CheckIcon />
                      {item}
                    </li>
                  ))}
      ...
      <section className="mx-auto w-full">
        <div className={containerClass}>
          <div className="grid grid-cols-3 gap-4 max-[767px]:grid-cols-1">
            ...
            <div className="relative col-span-2 flex flex-col justify-between gap-6 overflow-hidden rounded-[12px] bg-[#7d3fab] p-10 max-[767px]:col-span-1 max-[767px]:p-8">
              <span
            ...
            {benefits.map((b) => (
              ...
              >
                ...
                <p className="mt-auto text-[0.85rem] font-thin leading-[1.6] text-[#cfcfcf]">
                  {b.desc}
                </p>
              </div>
            ))}
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-4 gap-4 max-[991px]:grid-cols-2 max-[479px]:grid-cols-1">
              {[
                ...
                >
                  <span className="text-[2rem] font-medium text-[#f285f0]">{stat.value}</span>
                  <span className="text-[0.85rem] font-thin text-[#cfcfcf]">{stat.label}</span>
                </div>
              ))}
            </div>
            ...
            >
              ...
              <div className="flex w-[260px] shrink-0 flex-col gap-4 max-[767px]:w-full max-[767px]:flex-row max-[479px]:flex-col">
                <div className={`flex flex-1 flex-col gap-2 rounded-[12px] p-6 ${glassClass}`}>
                  <span className="text-[2.2rem] font-medium text-[#f285f0]">+230%</span>
                  <span className="text-[0.8rem] font-thin leading-[1.5] text-[#cfcfcf]">
                    Croissance de l'ARR depuis le début de l'accompagnement.
                  </span>
                </div>
                <div className={`flex flex-1 flex-col gap-2 rounded-[12px] p-6 ${glassClass}`}>
                  <span className="text-[2.2rem] font-medium text-[#f285f0]">+100K€</span>
                  <span className="text-[0.8rem] font-thin leading-[1.5] text-[#cfcfcf]">
