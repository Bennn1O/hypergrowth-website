          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-3 gap-4 max-[991px]:grid-cols-2 max-[479px]:grid-cols-1">
              {ops.map((op) => (
                <div
                  key={op.name}
                  className={`flex flex-col gap-5 rounded-[12px] p-6 ${glassClass} transition hover:-translate-y-0.5 hover:border-[#f285f030]`}
                >
                  <Image
                    src={op.photo}
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[0.8rem] text-[#f285f0]">{op.role}</p>
                  </div>
                  <p className="flex-1 text-[0.85rem] font-thin leading-[1.6] text-[#cfcfcf]">
                    {op.tagline}
                  </p>
              ...
              {experts.map((expert) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[0.8rem] text-[#f285f0]">{expert.role}</p>
                  </div>
                  <p className="flex-1 text-[0.85rem] font-thin leading-[1.6] text-[#cfcfcf]">
                    {expert.tagline}
                  </p>
