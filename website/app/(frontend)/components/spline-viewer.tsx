      ...
      <div className={`${className} rounded-lg bg-gradient-to-br from-[#803fab]/20 to-[#f285f0]/10 flex items-center justify-center`}>
        {fallback || (
          <div className="text-center">
            <p className="text-sm font-300 text-[#cfcfcf]">Impossible de charger la scène 3D</p>
          </div>
        )}
      </div>
    );
      ...
      {isLoading && (
        <div className="flex h-full items-center justify-center">
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm font-300 text-[#cfcfcf]">Chargement de la scène 3D...</p>
          </div>
        </div>
      )}
    </div>
      ...
      <SplineViewer
        ...
        fallback={
          <div className="bg-gradient-to-br from-[#803fab]/20 to-[#f285f0]/10 h-full flex items-center justify-center">
            <p className="text-sm font-300 text-[#cfcfcf]">Élément 3D en cours de chargement...</p>
          </div>
        }
      />
    </div>
