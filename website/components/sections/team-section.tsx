    ...
    <section className="mx-auto py-10">
      <div className={containerClass}>
        <div className="flex flex-col items-start justify-center max-[479px]:px-4">
          <div className="grid grid-cols-3 grid-rows-[auto_auto_auto] gap-4 max-[991px]:grid-cols-2 max-[479px]:grid-cols-1">
            <div className="flex flex-col justify-center gap-3">
              <span className="text-[0.75rem] font-medium uppercase tracking-[0.1em] text-white/40">L'écurie</span>
              <h2 className="text-[clamp(2.4rem,5.5vw,4rem)] font-medium leading-[1.08]">Les <span className="font-instrument-italic italic text-[#f285f0]">équipes</span></h2>
              <p className="max-w-[280px] text-[0.95rem] font-thin leading-[1.7] text-[#cfcfcf]">Découvrez les Operating partners et les experts qui constituent l'éco-système HyperGrowth.</p>
            </div>

            <div className={`flex flex-col items-start justify-center gap-16 rounded-[12px] p-8 ${glassClass}`}>
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-[1.5rem] leading-[1.2]">Killian Palermo</h3>
                <div className="font-thin text-[#cfcfcf]">Founder & Chief OP</div>
              </div>
            </div>
            ...
            <div className={`flex flex-col items-start justify-center gap-16 rounded-[12px] p-8 ${glassClass}`}>
              ...
              <div className="flex flex-col gap-2">
                <h3 className="text-[1.5rem] leading-[1.2]">Ulysse El Sherbeeny</h3>
                <div className="font-thin text-[#cfcfcf]">CEO & OP scaling perso</div>
              </div>
            </div>

            <div className="flex flex-col items-start justify-start gap-16 rounded-[12px] border border-white/10 bg-[var(--hpg-color-violet)] p-8">
              <div className="flex flex-col gap-4">
                <h3 className="text-[1.5rem] leading-[1.2]">Les OP</h3>
                <div className="flex">
                  {opPortraits.map((portrait, index) => (
                    <Image
                      key={portrait}
                      src={portrait}
                      alt=""
                      ...
                      style={{ outline: '4px solid var(--hpg-color-violet)', marginRight: index === opPortraits.length - 1 ? 0 : '-0.4rem' }}
                    />
                  ))}
                </div>
              </div>
              <div className="font-thin text-[#cfcfcf]">Ils vous accompagnent au quotidien, vous allègent, et vous aident à prendre les décisions.</div>
            </div>

            <div className="flex flex-col items-start justify-start gap-16 rounded-[12px] border border-white/10 bg-[var(--hpg-color-violet)] p-8">
              <div className="flex flex-col gap-4">
                <h3 className="text-[1.5rem] leading-[1.2]">Les Experts</h3>
                <div className="flex">
                  {expertPortraits.map((portrait, index) => (
                    <Image
                      key={portrait}
                      src={portrait}
                      alt=""
                      ...
                      height={40}
                      className="rounded-full"
                      style={{ outline: '4px solid var(--hpg-color-violet)', marginRight: index === expertPortraits.length - 1 ? 0 : '-0.4rem' }}
                    />
                  ))}
                </div>
              </div>
              <div className="font-thin text-[#cfcfcf]">Ils exécutent, apportent leur expertise et vous accompagne sur une mission précise.</div>
            </div>

            <div className="relative flex flex-col items-start justify-between gap-8 overflow-hidden rounded-[12px] border border-[#9a59c5]/30 p-8">
              <div
              ...
              <div className="relative z-10 flex flex-col gap-3">
                <h3 className="text-[1.5rem] leading-[1.2]">Prêt à scaler ?</h3>
